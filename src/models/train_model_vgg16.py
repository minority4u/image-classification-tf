...
import yaml
from src.models.vgg16_model import *
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", "-c", help="Define the path to config.yml", default="config/experiments/vgg16_base.yml", required=False)

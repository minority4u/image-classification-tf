...
def get_inception_v3_model(input_shape=(224, 224, 3)):
    ...
    Convolution2D_128 = Conv2D(name="Convolution2D_128", activation="relu", kernel_size=(1, 3),   filters=128, strides=(1, 2), padding="same")(Convolution2D_127)
    Convolution2D_121 = Conv2D(name="Convolution2D_121", activation="relu", kernel_size=(1, 1),   filters=128, padding="same")(merge_1)
    Convolution2D_122 = Conv2D(name="Convolution2D_122", activation="relu", kernel_size=(3, 1),   filters=128, padding="same")(Convolution2D_121)
    Convolution2D_123 = Conv2D(name="Convolution2D_123", activation="relu", kernel_size=(1, 3),   filters=128, padding="same")(Convolution2D_122)
